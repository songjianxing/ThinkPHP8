...
return [
    ...
    'You do not have permission to operate, please contact the administrator' => 'You do not have permission to operate, please contact the administrator',
    'The account does not exist' => 'The account does not exist',
    'Cannot delete super administrator' => 'Cannot delete super administrator',
    ...
    'admin_nickname_chs_alpha' => 'Nickname must be in Chinese or alphabet',
    'admin_role_id_number' => 'Role ID must be a number',
    'admin_role_id_require' => 'Role ID cannot be empty',
    'admin_password_max' => 'Login password cannot exceed 16 characters',
    'admin_password_require' => 'Login password cannot be empty',
    'admin_username_max' => 'Login account cannot exceed 55 characters',
